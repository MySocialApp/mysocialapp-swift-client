...
public class Track: Base {
    ...
    public static func decode(fromTrackingId id: String?) -> Track? {
    ...
    public static func decode(fromTrackingURL url: String?) -> Track? {
        if let u = url {
    ...
    public static func encode(deviceId: String?, userId: Int64?, rideId: String?) -> Track? {
    ...
    public convenience init(_ deviceId: String, _ userId: Int64, _ rideId: String) {
        self.init()
