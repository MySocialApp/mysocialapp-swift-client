...
public class RideShareData: Base {
    ...
    public convenience init(_ timestamp: Int64?, _ rideId: String?, _ latitude: Double?, _ longitude: Double?, _ altitude: Double?, _ accuracy: Float?, _ moving: Bool?, _ batteryLevel: Int?, _ flag: RideShareFlag?) {
        self.init()
